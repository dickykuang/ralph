...
Run /ralph-start to apply the new tasks.
```
...
After `/ralph-start` runs and creates new commits:

1. Re-run `/ralph-retro`
...
- All follow-up changes are applied by `/ralph-start`
