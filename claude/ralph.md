...
When implementing the `/ralph` command, run code context analysis as follows:
...
4. **Spawn subagent**: Use Task tool with the prompt template above
5. **Parse results**: Extract JSON from subagent response
